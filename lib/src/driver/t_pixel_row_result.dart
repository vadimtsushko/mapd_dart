 ...
 *  @generated
 */
library mapd.src.t_pixel_row_result;

import 'dart:typed_data' show Uint8List;
import 'package:thrift/thrift.dart';
import '../mapd.dart';

class TPixelRowResult implements TBase {
  static final TStruct _STRUCT_DESC = new TStruct("TPixelRowResult");
  static final TField _PIXEL_FIELD_DESC = new TField("pixel", TType.STRUCT, 1);
  static final TField _ROW_ID_FIELD_DESC = new TField("row_id", TType.I64, 2);
  static final TField _ROW_SET_FIELD_DESC = new TField("row_set", TType.STRUCT, 3);
  static final TField _NONCE_FIELD_DESC = new TField("nonce", TType.STRING, 4);

  TPixel _pixel;
  static const int PIXEL = 1;
  int _row_id = 0;
  static const int ROW_ID = 2;
  TRowSet _row_set;
  static const int ROW_SET = 3;
  String _nonce;
  ...
  String toString() {
    StringBuffer ret = new StringBuffer("TPixelRowResult(");
